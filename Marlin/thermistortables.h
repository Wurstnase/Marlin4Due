...
#if (THERMISTORHEATER_0 == 500) || (THERMISTORHEATER_1 == 500)  || (THERMISTORHEATER_2 == 500) || (THERMISTORHEATER_3 == 500) //Davinci Old Generation

const short temptable_500[][2] PROGMEM = {
{	24*OVERSAMPLENR		,	300	},
{	24.75*OVERSAMPLENR	,	290	},
{	28.25*OVERSAMPLENR	,	280	},
{	33*OVERSAMPLENR		,	270	},
{	38.75*OVERSAMPLENR	,	260	},
{	45*OVERSAMPLENR		,	250	},
{	52.75*OVERSAMPLENR	,	240	},
{	61.75*OVERSAMPLENR	,	230	},
{	73.25*OVERSAMPLENR	,	220	},
{	87.5*OVERSAMPLENR	,	210	},
{	105.25*OVERSAMPLENR	,	200	},
{	127*OVERSAMPLENR	,	190	},
{	152.75*OVERSAMPLENR	,	180	},
{	183*OVERSAMPLENR	,	170	},
{	217.75*OVERSAMPLENR	,	160	},
{	256*OVERSAMPLENR	,	150	},
{	298*OVERSAMPLENR	,	140	},
{	342.25*OVERSAMPLENR	,	130	},
{	388*OVERSAMPLENR	,	120	},
{	434.25*OVERSAMPLENR	,	110	},
{	475*OVERSAMPLENR	,	100	},
{	517.5*OVERSAMPLENR	,	90	},
{	554.75*OVERSAMPLENR	,	80	},
{	590.25*OVERSAMPLENR	,	70	},
{	619.5*OVERSAMPLENR	,	60	},
{	641.25*OVERSAMPLENR	,	50	},
{	657*OVERSAMPLENR	,	40	},
{	668.25*OVERSAMPLENR	,	30	},
{	677.5*OVERSAMPLENR	,	20	},
{	686.5*OVERSAMPLENR	,	10	},
{	695.75*OVERSAMPLENR	,	0	},
{	706*OVERSAMPLENR	,	-10	},
{	716*OVERSAMPLENR	,	-20	}
...
#if (THERMISTORHEATER_0 == 501) || (THERMISTORHEATER_1 == 501)  || (THERMISTORHEATER_2 == 501) || (THERMISTORHEATER_3 == 501) //Davinci new Generation

const short temptable_501[][2] PROGMEM = {
{	73.5*OVERSAMPLENR		,	320	},
{	93.75*OVERSAMPLENR		,	300	},
{	115.25*OVERSAMPLENR		,	284	},
{	131.5*OVERSAMPLENR		,	273	},
{	150.25*OVERSAMPLENR		,	263	},
{	168.5*OVERSAMPLENR		,	256	},
{	202.75*OVERSAMPLENR		,	241	},
{	231.25*OVERSAMPLENR		,	231	},
{	267.75*OVERSAMPLENR		,	221	},
{	304.75*OVERSAMPLENR		,	212	},
{	361.25*OVERSAMPLENR		,	198	},
{	418.25*OVERSAMPLENR		,	187	},
{	475.5*OVERSAMPLENR		,	177	},
{	546.75*OVERSAMPLENR		,	164	},
{	613.5*OVERSAMPLENR		,	153	},
{	668*OVERSAMPLENR		,	144	},
{	750*OVERSAMPLENR		,	131	},
{	799*OVERSAMPLENR		,	121	},
{	859.75*OVERSAMPLENR		,	108	},
{	895.75*OVERSAMPLENR		,	98	},
{	934*OVERSAMPLENR		,	85	},
{	974.75*OVERSAMPLENR		,	67	},
{	990*OVERSAMPLENR		,	56	},
{	1006*OVERSAMPLENR		,	42	},
{	1016.75*OVERSAMPLENR	,	24	},
{	1019.75*OVERSAMPLENR	,	19.5},
{	1025*OVERSAMPLENR		,	0	},
{	1030*OVERSAMPLENR		,	-20	}


};
#endif

#if (THERMISTORBED == 502) //Davinci bed thermistor
const short temptable_502[][2] PROGMEM = {
{	157*OVERSAMPLENR	,	160	},
{	214.75*OVERSAMPLENR	,	150	},
{	278.25*OVERSAMPLENR	,	140	},
{	345.5*OVERSAMPLENR	,	130	},
{	415*OVERSAMPLENR	,	120	},
{	484.5*OVERSAMPLENR	,	110	},
{	552.75*OVERSAMPLENR	,	100	},
{	618.25*OVERSAMPLENR	,	90	},
{	679.5*OVERSAMPLENR	,	80	},
{	736.25*OVERSAMPLENR	,	70	},
{	787*OVERSAMPLENR	,	60	},
{	832*OVERSAMPLENR	,	50	},
{	870.5*OVERSAMPLENR	,	40	},
{	903.25*OVERSAMPLENR	,	30	},
{	930.5*OVERSAMPLENR	,	20	},
{	953.75*OVERSAMPLENR	,	10	},
{	973.75*OVERSAMPLENR	,	0	},
{	993*OVERSAMPLENR	,	-10	},
{	1013.75*OVERSAMPLENR,	-20	}
