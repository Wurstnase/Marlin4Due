...
#define CUSTOM_MACHINE_NAME "Mrlin4Due"
...
#define DELTA_DIAGONAL_ROD 362.0 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 218.95 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 25.5 // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 9.88 // mm
...
//===========================================================================
//edit==================== ADD define for simple ============================
//===========================================================================
//ADD define for simple
...
//#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.1  // -below (always!)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 312 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 190}  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 90,46} // X,Y,Z Axis Extend and Retract angles
